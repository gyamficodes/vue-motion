<template>
 ...
 <h1>Mouse position is at: {{ x }}, {{ y }}</h1>
    ...
    <div>
        ...
        <button class=" w-[auto] p-1 bg-[#ccc] text-black" @click="increment">increaseCount</button>
...
const { x, y } = useMouse();
const ComposablesCounter = useCounter()
const {count, increment, decrement, reset} = ComposablesCounter;
</script>
